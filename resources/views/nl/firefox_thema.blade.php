...
@section('content')
    ...
    <p>Op Firefox kunt u thema's toepassen, waarmee u uw browser een beetje persoonlijkheid geven. <a
        ...
        bekijken. Klik vervolgens op eentje die u mooi vindt, en selecteer toepassen. Klaar, zo makkelijk is het! Wilt u
        een
        ander thema? Selecteer dan gewoon weer toepassen.</p>
